...
#endif
#ifndef OCALL_ENTER_INT_DEFINED__
#define OCALL_ENTER_INT_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_enter_int, (int* ptr));
#endif
#ifndef OCALL_ENTER_STRING_DEFINED__
#define OCALL_ENTER_STRING_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_enter_string, (char* ptr));
#endif
